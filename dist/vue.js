...
(function(
  ...
  function extend(to, _from) {
    // 将 from 的所有属性，都赋值到 to 的属性之上。
    for (var key in _from) {
      // 特别注意：此处，字符串作为【类数组】来处理。
      to[key] = _from[key];
    }
    return to;
  }
  ...
  function genStaticKeys(modules) {
    ...
    return modules
      .reduce(function(keys, m) {
        // 将 modules数组 的每个元素的 staticKeys ，拼接为一个新数组。（类似于 Array.prototype.map ）
        ...
        if (isArrayA && isArrayB) {
          ...
          return (
            ...
            a.every(function(e, i) {
              // Array.prototype.every。子项是否每一个，都满足特定条件。
